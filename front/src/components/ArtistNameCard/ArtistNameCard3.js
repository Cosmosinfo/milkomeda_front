...
import Icon from "../../assets/icon/clitz.png";

function ArtistNameCard3() {
  ...
  return (
    <>
      <StyledLink onClick={openModal}>
        <Modal3 open={modalOpen} close={closeModal} header="Artist Description">
          ...
          <NewArtistItemContainerBox>
            ...
            <NewArtistItemContainerRight>
              <NewArtistItemContainerNameBox>
                <NewArtistItemContainerArtistName>C.LITZ</NewArtistItemContainerArtistName>
              </NewArtistItemContainerNameBox>
...
export default ArtistNameCard3;
